...
define('LIBPATH', BASEPATH . "{$d_s}vendor{$d_s}codeigniter{$d_s}framework{$d_s}{$f_system}{$d_s}libraries{$d_s}Session{$d_s}");
...
require_once BASEPATH . "{$d_s}vendor{$d_s}codeigniter{$d_s}framework{$d_s}{$f_system}{$d_s}core{$d_s}Common.php";
