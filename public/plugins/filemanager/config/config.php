...
elseif ($_SESSION['filemanager_access']['read_access'] == TRUE) 
{
	...
	*/
	...
	|
	*/
	$config['upload_dir'] = $server_link.'/uploads/';
	...
	*/
	...
	|
	*/
	$config['thumbs_upload_dir'] = '/thumbs/';
	...
	*******************/
	...
	$config['fixed_path_from_filemanager']             = array('../../uploads/medium/'); //fixed path of the image folder from the current position on upload folder
