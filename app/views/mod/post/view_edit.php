...
<div class="page-inner">
	<div class="d-sm-flex align-items-center justify-content-between pd-b-20">
		...
		<div class="mg-t-15">
			...
			<button type="submit" class="btn btn-sm pd-x-15 btn-white btn-uppercase ml-2 submit_update"><i id="submit_icon" class="fa fa-save mr-2"></i><?=lang_line('button_save');?></button>
		</div>
	</div>
