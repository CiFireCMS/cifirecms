		...
		<div id="body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					...
					<small class="text-muted">Website url.</small><br/>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					...
					<small class="text-muted">Website name.</small><br/>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					...
					<small class="text-muted">Website slogan.</small><br/>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					...
					<small class="text-muted">Website description.</small><br/>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					...
					<small class="text-muted">Website email.</small><br/>
