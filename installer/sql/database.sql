...
(3, 0, 'CONTENT', '#', 'header', 3, 1, 'Y'),
(4, 0, 'Post', 'post', 'book-open', 4, 1, 'Y'),
(5, 0, 'Category', 'category', 'folder-plus', 5, 1, 'Y'),
(6, 0, 'Tag', 'tag', 'tag', 6, 1, 'Y'),
(7, 0, 'Comment', 'comment', 'message-square', 8, 1, 'Y'),
(8, 0, 'Pages', 'pages', 'file-text', 7, 1, 'Y'),
(9, 0, 'MEDIA', '#', 'header', 9, 1, 'Y'),
(10, 0, 'Gallery', 'gallery', 'image', 10, 1, 'Y'),
(11, 0, 'File Manager', 'filemanager', 'grid', 11, 1, 'Y'),
(12, 0, 'CONTACT', '#', 'header', 12, 1, 'Y'),
(13, 0, 'Mail', 'mail', 'mail', 13, 1, 'Y'),
(14, 0, 'USERS', '#', 'header', 14, 1, 'Y'),
(15, 0, 'User', 'user', 'users', 15, 1, 'Y'),
(16, 0, 'Permissions', 'permissions', 'shield', 16, 1, 'Y'),
(17, 0, 'MODULE', '#', 'header', 17, 1, 'Y'),
(18, 0, 'Component', 'component', 'box', 18, 1, 'Y'),
(19, 0, 'CoGen', 'cogen', 'coffee', 19, 1, 'Y'),
(20, 0, 'APPERANCE', '#', 'header', 20, 1, 'Y'),
(21, 0, 'Theme', 'theme', 'aperture', 21, 1, 'Y'),
(22, 0, 'Menu Manager', 'menumanager/?', 'list', 22, 1, 'Y'),
(23, 0, 'Setting', 'setting', 'settings', 23, 1, 'Y'),
(24, 0, 'Home', '/', '', 1, 2, 'Y'),
